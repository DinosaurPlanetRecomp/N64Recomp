...
namespace N64Recomp {
    ...
    public:
        ...
        virtual void emit_function_exit(const std::string& function_name, uint32_t address) const = 0;
    };
    ...
    public:
        ...
        void emit_function_exit(const std::string& function_name, uint32_t address) const final;
    private:
